        ...
        if os.path.isfile("fdmnes.txt"):
            ...
            # magnetic calculation
                ...
                js_new = {
                    ...
                    "mu": [
                        (float(i.split()[1]) + float(i.split()[2]))
                        for i in fdmnestxt[2:]
                    ],
                }
                js.update(js_new)

        # multiple sites
        elif os.path.isfile("fdmnes_1.txt"):
                ...
                try:
                    ...
                    # magnetic calculation
                        ...
                        js_new = {
                            ...
                            "e_%d" % t: [float(i.split()[0]) for i in fdmnestxt[2:]],
                            "mu_up_%d"
                            % t: [float(i.split()[1]) for i in fdmnestxt[2:]],
                            "mu_dw_%d"
                            % t: [float(i.split()[2]) for i in fdmnestxt[2:]],
                            "mu_%d"
                            % t: [
                                (float(i.split()[1]) + float(i.split()[2]))
                                for i in fdmnestxt[2:]
